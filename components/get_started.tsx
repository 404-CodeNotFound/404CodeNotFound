...
export const GetStarted = () => {
  return (
    <div className="pt-20" id="get_started">
      <Particles className="absolute inset-0 -z-10" />
      <div className="text-center px-8">
        <h1
          className="pb-4 font-extrabold tracking-tight text-transparent text-3xl lg:text-4xl  bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600"
          data-aos="fade-down"
        >
        ...
        <div className="mt-10 grid sm:grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          >
            <h2 className="text-2xl font-semibold mb-2">
              Landing Page <br></br>
              <span className="mb-8 text-lg text-zinc-300/40 font-medium">
                - or -
              </span>{" "}
              <br></br>
              Custom Website
